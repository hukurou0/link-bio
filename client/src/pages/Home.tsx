...
import { Youtube, Twitter, FileText, BookOpen } from "lucide-react";

export default function Home() {
  return (
    <div className="min-h-screen py-8 px-4">
      {/* Banner */}
      <div className="bg-primary text-primary-foreground text-center py-3 px-4 rounded-lg mb-8 text-sm shadow-md">
      ...
      <div className="max-w-md mx-auto">
        ...
        <section className="mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Note */}
            <div className="bg-[#DCFCE7] rounded-2xl p-4 shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300">
              <a
                href="https://note.com/huku_engineer"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center text-center h-full"
              >
                <div className="w-12 h-12 bg-[#10B981] rounded-full flex items-center justify-center mb-3 shadow-md">
                  <FileText className="w-6 h-6 text-white" />
                </div>
                <p className="text-xs text-[#047857]">@huku_engineer</p>
              </a>
            </div>
          </div>
        </section>
